...
public class Employee {
	...
	public Employee(int employeeId, String firstName, String lastName, String email, String phoneNumber,
			LocalDate hireDate, Job job, double salary, double commisionPct, Employee myBoss, Deparment deparment) {
		super();
	...
	public String toString() {
		return "Employee [employeeId=" + employeeId + ", firstName=" + firstName + ", lastName=" + lastName + ", email="
				...
				+ salary + ", commisionPct=" + commisionPct + ", myBoss=" + myBoss + ", deparment=" + deparment + "]";
	}
