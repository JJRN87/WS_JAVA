...
public class TestCountry {
	...
	public static void main(String[] args) {
		...
		Region region2 = arg.getRegion(); //Sería la manera de poner la región 2 como "indefinida"
		
		Country col = new Country ("CO", "Colombia", arg.getRegion());
		...
		System.out.println("Nombre región de españa : " + esp
														.getRegion()
														.getRegionName()
														.substring(0,3)
														.toUpperCase());
